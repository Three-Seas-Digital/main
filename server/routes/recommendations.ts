...
templateRouter.post('/', authenticateToken, async (req: any, res: Response) => {
  try {
...
recRouter.put('/:id/status', authenticateToken, async (req: any, res: Response) => {
  try {
...
recRouter.post('/:id/threads', authenticateToken, async (req: any, res: Response) => {
  try {
