...
router.post('/login', loginRateLimit(5, 60000), async (req: any, res: Response): Promise<void> => {
  try {
...
router.get('/verify-email', async (req: any, res: Response): Promise<void> => {
  try {
...
router.post('/resend-verification', async (req: any, res: Response): Promise<void> => {
  try {
...
router.put('/change-password', authenticateClient, async (req: any, res: Response): Promise<void> => {
  try {
