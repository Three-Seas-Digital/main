...
router.get('/:clientId/execution-plans', authenticateToken, async (req, res) => {
  try {
...
router.post('/:clientId/execution-plans', authenticateToken, async (req, res) => {
  try {
...
router.put('/:clientId/execution-plans/:id', authenticateToken, async (req, res) => {
  try {
    const { name, plan_data, start_date } = req.body;
    await pool.query(
...
router.delete('/:clientId/execution-plans/:id', authenticateToken, async (req, res) => {
  try {
