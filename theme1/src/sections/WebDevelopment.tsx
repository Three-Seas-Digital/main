...
import { ArrowRight, Zap, Accessibility, Palette, TestTube } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage: 'url(/dev-workspace.jpg)',
      ...
      >
        <span className="micro-label block mb-6">WEB DEVELOPMENT</span>

        <div className="mb-6">
          <h2 className="font-heading font-bold text-[clamp(32px,4.5vw,64px)] leading-[0.95] tracking-[-0.02em]">
            <span className="word inline-block text-[#F2F5FA]">FAST</span>
            <br />
        ...
        <p className="text-[#A7AFBF] text-base lg:text-lg leading-relaxed mb-8 max-w-md">
          Production-ready frontends, robust backends, and CI/CD that keeps
          releases boring (in a good way).
        </p>
      ...
      >
        ...
        <ul className="space-y-4">
          {buildStandards.map(({ icon: Icon, label }) => (
            <li
              key={label}
