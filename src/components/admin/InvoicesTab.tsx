...
export default function InvoicesTab() {
  ...
  const formatDate = (dateStr: string | undefined): string => dateStr ? new Date(dateStr).toLocaleDateString() : '-';

  const isOverdue = (inv: any): boolean => inv.status === 'unpaid' && inv.dueDate && new Date(inv.dueDate) < new Date();
