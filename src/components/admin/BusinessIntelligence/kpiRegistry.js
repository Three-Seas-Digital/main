...
const gr = (id, label, unit, desc) => ({ id, label, unit, tier: 'guardrail', desc });
...
export const INDUSTRY_KPI_PACKS = {
...
export function getAllKpisForClient(industry) {
...
export function getIndustryKpisByTier(industry) {
  const pack = getIndustryPack(industry);
...
export function getUniversalByCategory() {
  const groups = {};
