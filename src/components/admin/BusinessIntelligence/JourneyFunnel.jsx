...
function inPeriod(isoStr, period) {
...
function FunnelBar({ stageName, icon, count, maxCount, color, conversionRate, isLast }) {
...
export default function JourneyFunnel({ biClientId, onBiClientChange }) {
