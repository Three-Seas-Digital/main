...
function projectLinear(values, horizon) {
...
function projectCagr(values, horizon, multiplier) {
  const n = values.length;
...
function projectSma(values, horizon, multiplier) {
...
export default function ForecastingEngine({ biClientId, onBiClientChange }) {
  ...
  const project = useCallback((multiplier) => {
