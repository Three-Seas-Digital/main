...
interface ClientsTabProps {
  onClientViewed?: (clientId: string) => void;
}

export default function ClientsTab({ onClientViewed }: ClientsTabProps) {
  const {
  ...
  const [confirmReopenOnboarding, setConfirmReopenOnboarding] = useState<string | null>(null);
  ...
  const [deleteInvoiceConfirm, setDeleteInvoiceConfirm] = useState<any>(null);
  ...
  const fetchDocData = async (doc: any) => {
  ...
  const handleRegenerateDocument = async (doc: any) => {
    if (!client) return;
                ...
                <form onSubmit={handleDocumentUpload}>
                  <div className="form-row">
                    ...
                    <div className="form-group">
                      ...
                      >
                        {Object.entries(DOCUMENT_TYPES).map(([key, val]: [string, any]) => (
