...
export default function DeepSeaCreatures() {
  ...
  useEffect(() => {
    ...
    const render = (now) => {
      ...
      gl.uniform1f(uLightMode, document.documentElement.classList.contains('light-theme') ? 1.0 : 0.0);
  ...
  return <canvas ref={canvasRef} className="deep-sea-canvas" aria-hidden="true" />;
}
