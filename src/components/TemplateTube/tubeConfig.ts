...
export const TUBE = {
  ...
  rowSpeedRange: [0.7, 1.3] as [number, number],
...
export const TIER_CONFIG: Record<string, TierConfigEntry> = {
...
export function getGradientColors(id: number | string): [string, string] {
  if (typeof id === 'string') {
    let hash = 0;
