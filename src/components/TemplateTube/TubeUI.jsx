...
function FilterBar({ templates, activeFilters, onFilterChange }) {
...
function DetailPanel({ template, onClose, onPreview, navigate }) {
...
function HoverTooltip({ template, mousePos }) {
