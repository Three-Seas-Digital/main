...
// Cast to accept any props — some portal components get client via context, not props
type AC = React.ComponentType<any>;
const PortalDashboard = lazy(() => import('../components/portal/Dashboard')) as React.LazyExoticComponent<AC>;
const PortalScorecard = lazy(() => import('../components/portal/Scorecard')) as React.LazyExoticComponent<AC>;
const PortalGrowthMetrics = lazy(() => import('../components/portal/GrowthMetrics')) as React.LazyExoticComponent<AC>;
const PortalRecommendations = lazy(() => import('../components/portal/Recommendations')) as React.LazyExoticComponent<AC>;
const PortalServiceRequests = lazy(() => import('../components/portal/ServiceRequests')) as React.LazyExoticComponent<AC>;
const PortalFeedback = lazy(() => import('../components/portal/Feedback')) as React.LazyExoticComponent<AC>;
const PortalInterventions = lazy(() => import('../components/portal/Interventions')) as React.LazyExoticComponent<AC>;
const PortalRevenueView = lazy(() => import('../components/portal/RevenueView')) as React.LazyExoticComponent<AC>;
const PortalExpenseView = lazy(() => import('../components/portal/ExpenseView')) as React.LazyExoticComponent<AC>;
const PortalProfitabilityView = lazy(() => import('../components/portal/ProfitabilityView')) as React.LazyExoticComponent<AC>;
const PortalFinancialReports = lazy(() => import('../components/portal/FinancialReports')) as React.LazyExoticComponent<AC>;
const PortalOnboarding = lazy(() => import('../components/portal/Onboarding')) as React.LazyExoticComponent<AC>;
const PortalDocuments = lazy(() => import('../components/portal/Documents')) as React.LazyExoticComponent<AC>;
...
function SignUpStep() {
  ...
  const [verifyStatus, setVerifyStatus] = useState<'verifying' | 'success' | 'already' | 'error' | null>(null);
...
/* ===== PRINT INVOICE ===== */
function printInvoice(invoice: any, clientName: string) {
...
function PaymentModal({ invoice, clientId, onClose }: { invoice: any; clientId: string; onClose: () => void }) {
...
/* ===== PROFILE SETTINGS ===== */
function ProfileSettings({ client, onClose }: { client: any; onClose: () => void }) {
...
function ClientDashboard() {
  ...
  const getDeveloperName = (userId: string): string => {
