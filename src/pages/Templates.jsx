...
function FallbackCard({ template, previewUrl, onClick }) {
...
export default function Templates() {
  ...
  const [activeFilters, setActiveFilters] = useState({ tier: null, category: null });
  ...
  const handleCardHover = useCallback((template, event) => {
